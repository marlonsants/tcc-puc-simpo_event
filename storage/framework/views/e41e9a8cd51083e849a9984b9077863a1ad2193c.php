...
<head>
  ...
  <?php echo $__env->yieldPushContent('mask'); ?>
    ...
    <div class="container-fluid">
      ...
      <nav class="navbar navbar-inverse">
        <div class="navbar-header">
          <?php if(!empty($nome_evento[0]) ): ?>
          <a href="/autor/home" class="navbar-brand"><?php echo e($nome_evento[0]->nome_evento); ?></a>
          <?php else: ?>
        ...
        <?php if(session()->has('evento_id') ): ?>
        <div class="collapse navbar-collapse" id="menu">
          <ul class="nav navbar-nav">
            <?php if($acesso[0]['acesso_id'] == 2): ?>
              <?php if($data['dataAtual'] >= $data['data_ini_ava'] and $avaliador[0]->status == 1 ): ?>
              ...
              <ul class="nav navbar-nav ">
                ...
                <li class="dropdown"> 
                  <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">
                    ...
                    <?php echo e(session()->get('pessoa_nome')); ?>  
                    <?php else: ?> 
                    Login expirou!
                    <?php endif; ?>
                    <span class="caret"></span></a>
                    <ul class="dropdown-menu">
                      <li><a href="/autor/editarperfil/<?php echo e(session()->get('id')); ?>" class="text-center">Editar Perfil</a></li>
          ...
          <div class="col-xs-12 col-sm-12 col-md-12">  
            <div class="container-fluid">
              ...
              <div class="row" id="msg_suc">
                <div class='alert alert-success text-center'><?php echo e(session('mensagem')); ?></div>
              </div>
              <?php endif; ?>
