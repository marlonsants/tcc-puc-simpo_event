...
<div class="row">
	<div class="container-fluid">
		<div class="col-md-10 col-md-offset-1 centralizar-regras">
			<h3 class="centralizar text-info">Como parte do processo de submissão, é preciso dar ciência da conformidade do trabalho submetido em relação a todos os itens listados a seguir:</h3>
			<ol>
