                                                        ...
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top"
                                                                ...
                                                                <img align="center" alt=""
                                                                     src="{{asset('img/email/logo-02-200px.png')}}"
                                                                     width="200"
                                                    ...
                                                    <table align="left" width="100%" border="0" cellpadding="0"
                                                        ...
                                                        <tr>
                                                            <td class="mcnImageContent" valign="top"
                                                                ...
                                                                <img align="center" alt=""
                                                                     src="{{asset('img/email/ativacao-de-conta-medico.jpg')}}"
                                                                     width="600"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <div style="text-align: center;"><br>
                                                                    <span style="color:#47cadc"><span
                                                                                style="font-size:20px"><strong>Seu
                                                                                cadastro está quase
                                                                                pronto!</strong></span></span></div>
                                                ...
                                                <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                style="padding: 0px 18px 9px; font-style: normal; font-weight: normal;">

                                                                <p style="text-align: center; font-style: normal; font-weight: normal;">
                                                                    Olá, {{$admin->name}}.<br>
                                                                    Só falta confirmar sua conta!<br>
                                                                    <br>
                                                                    Clique no botão abaixo&nbsp;e Seja Bem vindo!</p>
                                            ...
                                            <tr>
                                                <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                           ...
                                                           style="border-collapse: separate !important;border-radius: 2px;background-color: #47CADC;">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" valign="middle" class="mcnButtonContent"
                                                                style="font-family: Helvetica; font-size: 18px; padding: 18px;">
                                                                <a class="mcnButton " title="Confirmar Cadastro"
                                                                   href="{{route('administrator.register.confirm',['uuid'=>$admin->uuid])}}"
                                                                   target="_self"
                                                                   style="font-weight: bold;letter-spacing: -0.5px;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Confirmar
                                                                    Cadastro</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="padding-top:9px; padding-left:18px; padding-bottom:9px; padding-right:18px;">
                                                                ...
                                                                <table border="0" cellspacing="0"
                                                                    ...
                                                                    <tr>
                                                                        <td valign="top" class="mcnTextContent"
                                                                            style="padding: 18px;color: #808080;font-family: Helvetica;font-size: 16px;line-height: 200%;text-align: center;">
                                                                            <h3>Ficou com dúvida? Fale com a gente
                                                                                ;)</h3>
                                                                            Basta clicar no botão abaixo e falar com
                                                                            nosso suporte.
                                                                        </td>
                                                                    </tr>
                                                                    </tbody>
                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                            ...
                                            <tr>
                                                <td style="padding-top:0; padding-right:18px; padding-bottom:18px; padding-left:18px;"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                           class="mcnButtonContentContainer"
                                                           style="border-collapse: separate !important;border-radius: 3px;background-color: #727272;">
                                                        <tbody>
                                                        <tr>
                                                            <td align="center" valign="middle" class="mcnButtonContent"
                                                                style="font-family: Arial; font-size: 16px; padding: 15px;">
                                                                <a class="mcnButton " title="Abrir Chat do Suporte"
                                                                   href=""
                                                                   target="_blank"
                                                                   style="font-weight: bold;letter-spacing: normal;line-height: 100%;text-align: center;text-decoration: none;color: #FFFFFF;">Abrir
                                                                    Chat do Suporte</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                                                                                ...
                                                                                                                <table align="left"
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td align="center"
                                                                                                                            ...
                                                                                                                            <a href="http://www.facebook.com/4EventsOficial"
                                                                                                                               target="_blank"><img
                                                                                                                ...
                                                                                                                <table align="left"
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td align="center"
                                                                                                                            ...
                                                                                                                            width="24"
                                                                                                                            class="mcnFollowIconContent">
                                                                                                                            <a href="http://instagram.com/4eventsoficial"
                                                                                                                               target="_blank"><img
                                                                                                                ...
                                                                                                                <table align="left"
                                                                                                                    ...
                                                                                                                    <tr>
                                                                                                                        ...
                                                                                                                        <td align="center"
                                                                                                                            ...
                                                                                                                            width="24"
                                                                                                                            class="mcnFollowIconContent">
                                                                                                                            <a href="https://www.4events.com.br"
                                                                                                                               target="_blank"><img
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <span style="color:#808080">Essa é uma mensagem automática, ok? Não é para responder esse e-mail.</span>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
                                                    ...
                                                    <table align="left" border="0" cellpadding="0" cellspacing="0"
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td valign="top" class="mcnTextContent"
                                                                ...
                                                                <a href="http://www.4events.com.br" target="_blank">www.4events.com.br</a>
                                                            </td>
                                                        </tr>
                                                        </tbody>
                                                    </table>
